...
| Paper preparation/contracts | `src/daxlab/runtime/paper_contracts.py`, `src/daxlab/runtime/readiness.py`, `docs/SHADOW_PAPER_ACCEPTANCE_V1.md`, `docs/PAPER_PREPARATION_V10.md`, relevant `tests/test_paper_*`, `tests/test_readiness.py` | Simulation/contracts/readiness only; PAPER needs explicit lifecycle/reconciliation/protection evidence and explicit user authorization | No broker adapter/live execution module is allowed by current design |
