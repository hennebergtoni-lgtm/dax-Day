...
- Last completed whole-number step: **2213**
- Last interrupted whole-number step: **2185**
- Active whole-number step: **2214**
...
- Next step after successful completion: **2215**
...
- Active Step 2214 scope: **Read-only projection of existing Candidate checkpoint and pinned reserved attempt/protection/guard; no load-time refresh or mutation.**
