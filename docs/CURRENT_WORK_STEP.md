...
- Active step state: **ACTIVE — READ-ONLY / NO BROKER SIDE EFFECT**
- Work tranche state: **MAIN_CHAT_CONTINUATION**
- Next step after successful completion: **2202**
...
| 2201 | Read-only first-DEMO-order readiness composition audit. | **ACTIVE.** Audit/compose current host, clock/feed, DEMO account, lookup support, economics, promoted risk/loss/sizing and protection evidence without any broker side effect. |
