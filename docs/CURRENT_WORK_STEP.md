...
| 2206 | Independent actual host/policy evidence and separate authorization lane. | **WAITING_EXTERNAL / USER_AUTH.** Retains its PLANNED external scope; no first-order authorization. Independent local operator Work advances under continuity section 4A. |
