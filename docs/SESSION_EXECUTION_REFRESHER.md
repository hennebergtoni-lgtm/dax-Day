...
Before the first concrete tool/code action after any `weiter`, `fortsetzen`, resume, context reconstruction, reconnect, tool disruption or new work turn, verify these six items:
