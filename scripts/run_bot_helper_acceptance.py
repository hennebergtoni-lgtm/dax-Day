...
GROUP_MODULES = {
    ...
    "T07": ("test_run_ig_predemo_readiness_2238", "test_dax_windows_host_preflight",
            "test_dax_windows_python_runtime_probe", "test_ig_rest_readonly",
            "test_ig_rest_readonly_inventory"),
